...
本项目是一个面向连锁药店业务场景的安全优先（Security-by-Design）管理平台。系统在实现完整进销存业务（采购、销售、退货、调拨）的基础上，深度集成了多层安全防御机制。
...
```bash
1. 克隆项目
git clone https://github.com/halouworld226/Security-Pharmacy-System-2026-gzic.git
